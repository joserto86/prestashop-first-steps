...
class __TwigTemplate_7717380a95ae766c76f054767bcbd87a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@Modules/ps_googleanalytics/classes/Hook/HookDisplayFooter.php";
    }
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/classes/Hook/HookDisplayFooter.php", "/var/www/html/modules/ps_googleanalytics/classes/Hook/HookDisplayFooter.php");
    }
}
