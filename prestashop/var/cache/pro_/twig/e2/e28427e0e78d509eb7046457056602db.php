...
class __TwigTemplate_7558cd5d3917c193d63926a9544b46ed extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_linklist/composer.lock", "/var/www/html/modules/ps_linklist/composer.lock");
    }
}
