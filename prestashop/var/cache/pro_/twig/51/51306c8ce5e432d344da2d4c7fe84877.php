...
class __TwigTemplate_46eb9a5d80f91ff02e581dfa8d6675db extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/statsregistrations/statsregistrations.php", "/var/www/html/modules/statsregistrations/statsregistrations.php");
    }
}
