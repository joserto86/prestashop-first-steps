...
/* @Modules/ps_linklist/upgrade/upgrade-3.0.php */
class __TwigTemplate_ef6c22bf40832da9fce90dbc99be0744 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@Modules/ps_linklist/upgrade/upgrade-3.0.php";
    }
    ...
    {
        return new Source("", "@Modules/ps_linklist/upgrade/upgrade-3.0.php", "/var/www/html/modules/ps_linklist/upgrade/upgrade-3.0.php");
    }
}
