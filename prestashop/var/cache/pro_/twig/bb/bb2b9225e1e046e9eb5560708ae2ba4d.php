...
class __TwigTemplate_895db59d535fecaa7c30c5aecd104cef extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/psgdpr/classes/GDPRConsent.php", "/var/www/html/modules/psgdpr/classes/GDPRConsent.php");
    }
}
