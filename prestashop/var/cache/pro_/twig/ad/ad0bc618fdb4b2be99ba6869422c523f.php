...
/* @Modules/ps_emailsubscription/mails/es/newsletter_voucher.html */
class __TwigTemplate_b0e08940c8fb3017335ed69f067e45b9 extends Template
{
    private $source;
    private $macros = [];
...
<head>
  <title> Cupón de descuento del Boletín de Noticias </title>
  <!--[if !mso]><!-->
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; padding-bottom: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;font-weight:600;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Suscribirse al boletín de noticias</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Gracias por suscribirse a nuestro boletín de noticias. Nos complace ofrecerle el siguiente cupón de descuento: <span class=\"label\" style=\"font-weight: 700;\">{discount}</span>
</div>
                                        </td>
                                      </tr>
                                    </tbody>
...
";
    ...
    {
        return "@Modules/ps_emailsubscription/mails/es/newsletter_voucher.html";
    }
    ...
    {
        return new Source("", "@Modules/ps_emailsubscription/mails/es/newsletter_voucher.html", "/var/www/html/modules/ps_emailsubscription/mails/es/newsletter_voucher.html");
    }
}
