...
class __TwigTemplate_2a9bb8cdb636455d3a31424d3bd1c8fd extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/classes/Hook/HookActionProductCancel.php", "/var/www/html/modules/ps_googleanalytics/classes/Hook/HookActionProductCancel.php");
    }
}
