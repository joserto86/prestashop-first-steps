...
class __TwigTemplate_6a69263faf381e8289f8ba80cd09d38a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/statsdata/statsdata.php", "/var/www/html/modules/statsdata/statsdata.php");
    }
}
