...
class __TwigTemplate_14fa89a217e02c03ffd70fc2586b9dbc extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
      <tr>
        ...
        if ((($context["templateType"] ?? null) == "html")) {
            ...
            echo "&nbsp;-&nbsp;";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Payment processed", [], "Emails.Body", ($context["locale"] ?? null));
            echo "
              </p>
...
";
        ...
        echo "            <span>
              ";
        // line 30
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Your payment for order with the reference <strong><span>{order_name}</span></strong> was successfully processed.", [], "Emails.Body", ($context["locale"] ?? null));
        echo "
            </span>
          </font>
        </td>
