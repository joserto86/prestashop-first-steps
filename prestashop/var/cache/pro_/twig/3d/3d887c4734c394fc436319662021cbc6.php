...
class __TwigTemplate_cd75cf2928d8d4a8093d7349edc5f24b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/contactform/composer.lock", "/var/www/html/modules/contactform/composer.lock");
    }
}
