...
class __TwigTemplate_d5c58d61a26dc76e26d7ffbd4edc3757 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_contactinfo/ps_contactinfo.php", "/var/www/html/modules/ps_contactinfo/ps_contactinfo.php");
    }
}
