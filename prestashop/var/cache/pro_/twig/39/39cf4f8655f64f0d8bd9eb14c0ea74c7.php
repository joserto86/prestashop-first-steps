...
class __TwigTemplate_3d19248cd9e1baa04557f59473cbbbea extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/psgdpr/translations/pt.php", "/var/www/html/modules/psgdpr/translations/pt.php");
    }
}
