...
class __TwigTemplate_73aa360195ed5231b4db976bca0a86cf extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_checkpayment/composer.lock", "/var/www/html/modules/ps_checkpayment/composer.lock");
    }
}
