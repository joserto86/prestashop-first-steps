...
class __TwigTemplate_e7a975297a8dd26c6bc22af4d0f98165 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_faviconnotificationbo/ps_faviconnotificationbo.php", "/var/www/html/modules/ps_faviconnotificationbo/ps_faviconnotificationbo.php");
    }
}
