...
class __TwigTemplate_856dd00288cba67ea0b198b5d7f71f17 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_supplierlist/composer.lock", "/var/www/html/modules/ps_supplierlist/composer.lock");
    }
}
