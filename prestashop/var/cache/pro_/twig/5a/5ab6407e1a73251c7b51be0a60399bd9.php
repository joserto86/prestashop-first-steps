...
class __TwigTemplate_bd62b6cae73d6605291c7836ccbb358c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_categorytree/composer.lock", "/var/www/html/modules/ps_categorytree/composer.lock");
    }
}
