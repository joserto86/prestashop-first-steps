...
class __TwigTemplate_4a61a2f79dcb4cb2b05261c4241cd54d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/dashactivity/upgrade/upgrade-2.1.0.php", "/var/www/html/modules/dashactivity/upgrade/upgrade-2.1.0.php");
    }
}
