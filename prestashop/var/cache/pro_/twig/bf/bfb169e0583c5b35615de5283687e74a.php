...
class __TwigTemplate_c03dfa67835952ffe4e50698b114bf5d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/statsbestcategories/statsbestcategories.php", "/var/www/html/modules/statsbestcategories/statsbestcategories.php");
    }
}
