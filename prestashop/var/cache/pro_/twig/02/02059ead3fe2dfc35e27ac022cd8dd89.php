...
class __TwigTemplate_032ed426d4ad2eb4e2b786bb46327efd extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/ps_googleanalytics.php", "/var/www/html/modules/ps_googleanalytics/ps_googleanalytics.php");
    }
}
