...
/* @Modules/ps_emailalerts/mails/es/customer_qty.html */
class __TwigTemplate_7855b309bc83d1c15b01e95800561bf3 extends Template
{
    private $source;
    private $macros = [];
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; padding-bottom: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;font-weight:600;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">{product} ya está disponible.</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">¡Buenas noticias, este artículo vuelve a estar en stock!</div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Haga clic en el siguiente enlace para visitar la página del producto y realizar su pedido: <a href=\"{product_link}\" target=\"_blank\" style=\"color: #25B9D7; text-decoration: underline; font-weight: 600;\">{product}</a>
</div>
                                        </td>
                                      </tr>
                                    </tbody>
...
";
    ...
    {
        return "@Modules/ps_emailalerts/mails/es/customer_qty.html";
    }
    ...
    {
        return new Source("", "@Modules/ps_emailalerts/mails/es/customer_qty.html", "/var/www/html/modules/ps_emailalerts/mails/es/customer_qty.html");
    }
}
