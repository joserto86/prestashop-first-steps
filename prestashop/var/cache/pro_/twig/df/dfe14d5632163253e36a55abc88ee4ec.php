...
class __TwigTemplate_eb2b1ff42ee7d261f2ed18427d30a8dd extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_linklist/src/Form/LinkBlockFormDataProvider.php", "/var/www/html/modules/ps_linklist/src/Form/LinkBlockFormDataProvider.php");
    }
}
