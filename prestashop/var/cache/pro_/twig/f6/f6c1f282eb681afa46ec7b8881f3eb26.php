...
class __TwigTemplate_eccf004a3e7b7095c9faf230f740ffbb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/productcomments/controllers/front/UpdateCommentUsefulness.php", "/var/www/html/modules/productcomments/controllers/front/UpdateCommentUsefulness.php");
    }
}
