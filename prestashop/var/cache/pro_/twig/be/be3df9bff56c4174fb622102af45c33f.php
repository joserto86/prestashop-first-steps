...
/* @Modules/referralprogram/mails/es/referralprogram-congratulations.html */
class __TwigTemplate_d2298c2a2882acc4ccb65f0604c76419 extends Template
{
    private $source;
    private $macros = [];
...
<head>
  <title> Enhorabuena del programa de referidos </title>
  <!--[if !mso]><!-->
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">¡Su amigo referido <span class=\"label\" style=\"font-weight: 700;\">{sponsored_firstname}</span> <span class=\"label\" style=\"font-weight: 700;\">{sponsored_lastname}</span> ha realizado su primera compra en <a href=\"{shop_url}\" style=\"color: #25B9D7; text-decoration: underline; font-weight: 600;\">{shop_name}</a>!</div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Nos complace ofrecerle un cupón de descuento valorado en <span class=\"label\" style=\"font-weight: 700;\">{discount_display}</span> (CUPÓN # <span class=\"label\" style=\"font-weight: 700;\">{discount_name}</span>) para que lo utilice en su próximo pedido.</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
";
    ...
    {
        return "@Modules/referralprogram/mails/es/referralprogram-congratulations.html";
    }
    ...
    {
        return new Source("", "@Modules/referralprogram/mails/es/referralprogram-congratulations.html", "/var/www/html/modules/referralprogram/mails/es/referralprogram-congratulations.html");
    }
}
