...
class __TwigTemplate_4b7aea62e27eab38e7b42790b73c1e33 extends Template
{
    private $source;
    private $macros = [];
  ...
  <td align=\"center\" class=\"titleblock\">
    <font size=\"2\" face=\"";
      ...
      <span class=\"subtitle\">";
        // line 8
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Thanks for your order with the reference {order_name} from {shop_name}.", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
        echo "</span>
    </font>
  </td>
</tr>
    ...
    <table class=\"table\">
      <tr>
        ...
        if ((($context["templateType"] ?? null) == "html")) {
            ...
            echo "&nbsp;-&nbsp;";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Item(s) out of stock", [], "Emails.Body", ($context["locale"] ?? null));
            echo "
              </p>
...
";
    ...
    {
        return array (  137 => 55,  132 => 53,  122 => 46,  117 => 44,  100 => 30,  97 => 29,  88 => 25,  84 => 23,  82 => 22,  78 => 21,  62 => 8,  58 => 7,  54 => 6,  50 => 4,  46 => 3,  35 => 1,);
    }
