...
/* @Modules/ps_emailalerts/mails/es/order_changed.html */
class __TwigTemplate_1206261d2a35836b9ab2a095280d69fd extends Template
{
    private $source;
    private $macros = [];
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; padding-bottom: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;font-weight:600;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">ID Pedido {order_name} - Pedido modificado</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Su pedido con número de referencia <span class=\"label\" style=\"font-weight: 700;\">{order_name}</span> de <span class=\"label\" style=\"font-weight: 700;\">{shop_name}</span> ha sido modificado por el comerciante.</div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Diríjase a su cuenta de cliente para obtener más información al respecto.</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                        ...
                        <div class=\"mj-column-per-100 mj-outlook-group-fix\" style=\"font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;\" align=\"left\" width=\"100%\">
                          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; vertical-align: top;\" width=\"100%\">
                            <tbody>
                              <tr>
                                <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                  <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Si tiene una cuenta de invitado, puede seguir su pedido desde la sección: <a href=\"{guest_tracking_url}\" target=\"_blank\" style=\"color: #25B9D7; text-decoration: underline; font-weight: 600;\">Seguimiento de pedido</a> de nuestra tienda.</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
...
";
    ...
    {
        return "@Modules/ps_emailalerts/mails/es/order_changed.html";
    }
    ...
    {
        return new Source("", "@Modules/ps_emailalerts/mails/es/order_changed.html", "/var/www/html/modules/ps_emailalerts/mails/es/order_changed.html");
    }
}
