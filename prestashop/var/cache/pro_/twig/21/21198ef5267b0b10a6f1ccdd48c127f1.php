...
class __TwigTemplate_e2d554a946f4ee335a04ec73b3ffec2b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/classes/Hook/HookDisplayHeader.php", "/var/www/html/modules/ps_googleanalytics/classes/Hook/HookDisplayHeader.php");
    }
}
