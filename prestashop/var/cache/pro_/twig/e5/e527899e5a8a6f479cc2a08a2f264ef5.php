...
class __TwigTemplate_3a19417a4a57ff385f79d6be547887f5 extends Template
{
    private $source;
    private $macros = [];
  ...
  <figcaption class=\"figure-caption\">
    ...
    <button class=\"btn btn-outline-danger btn-sm js-form-submit-btn\"
        ...
        // line 30
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_suppliers_delete_logo_image", ["supplierId" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 30), "get", [0 => "supplierId"], "method", false, false, false, 30)]), "html", null, true);
        echo "\"
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Catalog/Suppliers/logo_image.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Catalog/Suppliers/logo_image.html.twig");
    }
}
