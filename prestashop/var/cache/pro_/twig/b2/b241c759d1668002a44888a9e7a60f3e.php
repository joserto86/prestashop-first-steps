...
class __TwigTemplate_e3d6dd0e5aa4cbfe906f8dc9680eb72a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/blockwishlist/_dev/front/js/pages/list/index.js", "/var/www/html/modules/blockwishlist/_dev/front/js/pages/list/index.js");
    }
}
