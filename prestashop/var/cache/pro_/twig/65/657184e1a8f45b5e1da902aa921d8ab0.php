...
/* @Modules/ps_emailsubscription/mails/es/newsletter_verif.html */
class __TwigTemplate_f97fc3dcc82d321026021ad2fca1c2ce extends Template
{
    private $source;
    private $macros = [];
...
<head>
  <title> Verificación de registro al boletín de noticias </title>
  <!--[if !mso]><!-->
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Gracias por suscribirse a nuestro boletín de noticias. Haga clic en el siguiente enlace para confirmar su solicitud:<br>
...
";
    ...
    {
        return "@Modules/ps_emailsubscription/mails/es/newsletter_verif.html";
    }
    ...
    {
        return new Source("", "@Modules/ps_emailsubscription/mails/es/newsletter_verif.html", "/var/www/html/modules/ps_emailsubscription/mails/es/newsletter_verif.html");
    }
}
