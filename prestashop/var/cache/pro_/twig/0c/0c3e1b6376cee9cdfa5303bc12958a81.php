...
/* @Modules/ps_googleanalytics/translations/it.php */
class __TwigTemplate_d5ed7f4114321102de2a90e77ce9a96a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@Modules/ps_googleanalytics/translations/it.php";
    }
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/translations/it.php", "/var/www/html/modules/ps_googleanalytics/translations/it.php");
    }
}
