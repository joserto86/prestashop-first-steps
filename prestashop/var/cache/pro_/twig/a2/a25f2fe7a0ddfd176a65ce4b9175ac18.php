...
class __TwigTemplate_7ee7cd2c7b2bdbac41336b086b6b4034 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_contactinfo/composer.lock", "/var/www/html/modules/ps_contactinfo/composer.lock");
    }
}
