...
class __TwigTemplate_c06116e1af75b8760904187edf54f4b2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/blockwishlist/_dev/front/js/components/Create/Create.vue", "/var/www/html/modules/blockwishlist/_dev/front/js/components/Create/Create.vue");
    }
}
