...
class __TwigTemplate_d41ba8e05274eb39771e0722f93d383f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/blockwishlist/_dev/front/js/components/Button/Button.vue", "/var/www/html/modules/blockwishlist/_dev/front/js/components/Button/Button.vue");
    }
}
