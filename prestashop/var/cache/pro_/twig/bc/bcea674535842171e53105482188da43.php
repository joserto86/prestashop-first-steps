...
class __TwigTemplate_9458650425563d84ad19bc7e5bebecd7 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_emailsubscription/ps_emailsubscription.php", "/var/www/html/modules/ps_emailsubscription/ps_emailsubscription.php");
    }
}
