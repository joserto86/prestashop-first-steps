...
class __TwigTemplate_550e42bf65075599fc4414cc41ee4a46 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_languageselector/composer.lock", "/var/www/html/modules/ps_languageselector/composer.lock");
    }
}
