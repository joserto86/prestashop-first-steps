...
class __TwigTemplate_cfa5cf94db1e1d2f3a1790306234d04c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_cashondelivery/upgrade/upgrade-2.0.0.php", "/var/www/html/modules/ps_cashondelivery/upgrade/upgrade-2.0.0.php");
    }
}
