...
/* @Modules/referralprogram/mails/es/referralprogram-invitation.html */
class __TwigTemplate_8717cd90c31eaa09173568b87c678a1b extends Template
{
    private $source;
    private $macros = [];
...
<head>
  <title> Invitación al programa de referidos </title>
  <!--[if !mso]><!-->
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0; padding-bottom: 20px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:20px;font-weight:600;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">{firstname_friend} {lastname_friend}, ¡Únase!</div>
                                        </td>
                                      </tr>
                                      <!-- TITLE ENDING -->
                                    </tbody>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">¡Su amigo <span class=\"label\" style=\"font-weight: 700;\">{firstname} {lastname}</span> quiere referirle en <a href=\"{shop_url}\" target=\"_blank\" style=\"color: #25B9D7; text-decoration: underline; font-weight: 600;\">{shop_name}</a>!</div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Nos complace ofrecerle un cupón de descuento valorado en <span class=\"label\" style=\"font-weight: 700;\">{discount}</span> para que lo utilice en su próximo pedido.
                                            ¡Afíliese y obtega un cupón de descuento de <span class=\"label\" style=\"font-weight: 700;\">{discount}</span>!
                                            <p style=\"display: block; margin: 13px 0;\">
                                              <a href=\"{link}\" class=\"light\" target=\"_blank\" style=\"color: #25B9D7; text-decoration: underline; font-weight: 400;\">Es muy fácil registrarse. ¡Solo haga clic aquí!</a>
                                            </p>
                                          </div>
                                        </td>
                                      </tr>
                        ...
                        <div class=\"mj-column-per-100 mj-outlook-group-fix\" style=\"font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;\" align=\"left\" width=\"100%\">
                          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; vertical-align: top;\" width=\"100%\">
                            <tbody>
                              <tr>
                                <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                  <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Al registrarse, no olvide proporcionar la dirección de correo electrónico de su amigo referente: <span class=\"label\" style=\"font-weight: 700;\">{email}</span>.</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                            ...
                            <tbody>
                              <tr>
                                <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0; word-break: break-word;\">
                                  <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Saludos.</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
...
";
    ...
    {
        return "@Modules/referralprogram/mails/es/referralprogram-invitation.html";
    }
    ...
    {
        return new Source("", "@Modules/referralprogram/mails/es/referralprogram-invitation.html", "/var/www/html/modules/referralprogram/mails/es/referralprogram-invitation.html");
    }
}
