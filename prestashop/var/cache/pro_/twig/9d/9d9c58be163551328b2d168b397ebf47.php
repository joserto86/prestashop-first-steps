...
class __TwigTemplate_166cf0b40995d4b7d175241fca4c3abe extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/psgdpr/controllers/front/ExportDataToCsv.php", "/var/www/html/modules/psgdpr/controllers/front/ExportDataToCsv.php");
    }
}
