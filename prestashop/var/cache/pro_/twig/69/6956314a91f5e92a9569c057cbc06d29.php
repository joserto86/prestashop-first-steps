...
/* @Modules/ps_emailalerts/mails/es/return_slip.html */
class __TwigTemplate_d32647e7cbd0624f11ee43b560832067 extends Template
{
    private $source;
    private $macros = [];
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; padding-bottom: 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Has recibido una nueva solicitud de devolución en {shop_name}.</div>
                                        </td>
                                      </tr>
                                      <!-- H2 TITLE ENDING -->
                                    </tbody>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; padding-bottom: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;font-weight:600;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Detalles de devolución</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
<span class=\"label\" style=\"font-weight: 700;\">Pedido:</span> {order_name} Realizado el {date}</div>
                                      ...
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">
<span class=\"label\" style=\"font-weight: 700;\">Cliente:</span> {firstname} {lastname}, ({email})</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
";
    ...
    {
        return "@Modules/ps_emailalerts/mails/es/return_slip.html";
    }
    ...
    {
        return new Source("", "@Modules/ps_emailalerts/mails/es/return_slip.html", "/var/www/html/modules/ps_emailalerts/mails/es/return_slip.html");
    }
}
