...
/* @Modules/ps_emailalerts/mails/es/productcoverage.html */
class __TwigTemplate_e781ffe08f6c04ef79b9230d71afd2f4 extends Template
{
    private $source;
    private $macros = [];
...
<head>
  <title> Cobertura del producto </title>
  <!--[if !mso]><!-->
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">La cobertura de stock es ahora menor que el mínimo especificado de:<span class=\"label\" style=\"font-weight: 700;\"> {warning_coverage}</span>
</div>
                                        </td>
                                      </tr>
                                      <tr>
...
<span style=\"font-size:16px; font-weight: 700\">Cobertura de stock actual:</span> {current_coverage}</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
";
    ...
    {
        return "@Modules/ps_emailalerts/mails/es/productcoverage.html";
    }
    ...
    {
        return new Source("", "@Modules/ps_emailalerts/mails/es/productcoverage.html", "/var/www/html/modules/ps_emailalerts/mails/es/productcoverage.html");
    }
}
