...
/* @Modules/ps_emailsubscription/mails/es/newsletter_conf.html */
class __TwigTemplate_e5f9cbb7b96faee6db300df6940c1bce extends Template
{
    private $source;
    private $macros = [];
...
<head>
  <title> Confirmación de la suscripción a nuestro boletín de noticias </title>
  <!--[if !mso]><!-->
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;font-weight:600;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Gracias por suscribirse a nuestro boletín de noticias.</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
";
    ...
    {
        return "@Modules/ps_emailsubscription/mails/es/newsletter_conf.html";
    }
    ...
    {
        return new Source("", "@Modules/ps_emailsubscription/mails/es/newsletter_conf.html", "/var/www/html/modules/ps_emailsubscription/mails/es/newsletter_conf.html");
    }
}
