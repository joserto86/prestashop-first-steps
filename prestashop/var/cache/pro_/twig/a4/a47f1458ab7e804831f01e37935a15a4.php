...
class __TwigTemplate_b76667a3bd50f90935ec2c6a0f70c377 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
      <tr>
        ...
        if ((($context["templateType"] ?? null) == "html")) {
            ...
            echo "&nbsp;-&nbsp;";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Processing", [], "Emails.Body", ($context["locale"] ?? null));
            echo "
              </p>
...
";
        ...
        echo "            <span>
              ";
        // line 29
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("We are currently processing your <strong><span>{shop_name}</span></strong> order with the reference <strong><span>{order_name}</span></strong>.", [], "Emails.Body", ($context["locale"] ?? null));
        echo "
            </span>
          </font>
        </td>
