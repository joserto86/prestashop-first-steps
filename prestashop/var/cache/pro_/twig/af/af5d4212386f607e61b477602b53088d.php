...
class __TwigTemplate_a4bcc5652b8231f6d1de29bf2cb43972 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_emailsubscription/composer.lock", "/var/www/html/modules/ps_emailsubscription/composer.lock");
    }
}
