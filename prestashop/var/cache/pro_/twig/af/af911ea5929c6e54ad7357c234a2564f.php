...
class __TwigTemplate_94b20211a3b207be3e90307f14ad191a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_facetedsearch/src/Adapter/InterfaceAdapter.php", "/var/www/html/modules/ps_facetedsearch/src/Adapter/InterfaceAdapter.php");
    }
}
