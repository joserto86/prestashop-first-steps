...
class __TwigTemplate_335f3b25192a4a2352b6d180bec3b16c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/classes/Hook/HookActionOrderStatusPostUpdate.php", "/var/www/html/modules/ps_googleanalytics/classes/Hook/HookActionOrderStatusPostUpdate.php");
    }
}
