...
class __TwigTemplate_c1c26a5a6798e841600761ac3cc691fb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/classes/Hook/HookActionCarrierProcess.php", "/var/www/html/modules/ps_googleanalytics/classes/Hook/HookActionCarrierProcess.php");
    }
}
