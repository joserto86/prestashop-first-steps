...
class __TwigTemplate_b983997681d239d9686b0adf81e2d5ad extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_cashondelivery/ps_cashondelivery.php", "/var/www/html/modules/ps_cashondelivery/ps_cashondelivery.php");
    }
}
