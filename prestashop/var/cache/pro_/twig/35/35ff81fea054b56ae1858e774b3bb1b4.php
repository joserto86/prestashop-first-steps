...
/* @Modules/ps_googleanalytics/translations/es.php */
class __TwigTemplate_98de888ebf3bf6a1ae06c3b42dc226be extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@Modules/ps_googleanalytics/translations/es.php";
    }
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/translations/es.php", "/var/www/html/modules/ps_googleanalytics/translations/es.php");
    }
}
