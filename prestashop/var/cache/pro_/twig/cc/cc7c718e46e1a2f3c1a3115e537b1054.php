...
class __TwigTemplate_2b30eed935c294353abefa64275fc2ee extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/dashproducts/dashproducts.php", "/var/www/html/modules/dashproducts/dashproducts.php");
    }
}
