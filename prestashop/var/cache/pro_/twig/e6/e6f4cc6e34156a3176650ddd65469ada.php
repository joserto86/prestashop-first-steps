...
class __TwigTemplate_9bf54e6825f46829904293b70215a76a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_linklist/config/services.yml", "/var/www/html/modules/ps_linklist/config/services.yml");
    }
}
