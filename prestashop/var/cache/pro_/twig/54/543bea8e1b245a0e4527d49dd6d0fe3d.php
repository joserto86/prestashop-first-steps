...
/* @Modules/ps_googleanalytics/translations/fr.php */
class __TwigTemplate_fdab8efbf49183b6d164b54c9df1cdce extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@Modules/ps_googleanalytics/translations/fr.php";
    }
    ...
    {
        return new Source("", "@Modules/ps_googleanalytics/translations/fr.php", "/var/www/html/modules/ps_googleanalytics/translations/fr.php");
    }
}
