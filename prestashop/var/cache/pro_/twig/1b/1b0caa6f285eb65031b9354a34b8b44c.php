...
class __TwigTemplate_3d0befef39f4c118d5af13e12f02d1b4 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/dashactivity/dashactivity.php", "/var/www/html/modules/dashactivity/dashactivity.php");
    }
}
