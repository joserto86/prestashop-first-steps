...
class __TwigTemplate_4d3cc06b033e81fcb10040643710a2ec extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/blockreassurance/blockreassurance.php", "/var/www/html/modules/blockreassurance/blockreassurance.php");
    }
}
