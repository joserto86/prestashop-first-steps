...
/* @Modules/ps_reminder/mails/es/followup_4.html */
class __TwigTemplate_5b9b6e309038f377f2fd992ec3222a9f extends Template
{
    private $source;
    private $macros = [];
                                  ...
                                  <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;\" width=\"100%\">
                                    <tr>
                                      <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                        <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Usted es uno de nuestros mejores clientes, sin embargo, no ha realizado ningún pedido desde hace {days_threshold} días.</div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; word-break: break-word;\">
                                        <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Su carrito ha sido guardado, puede reanudar su pedido visitando nuestra tienda: <a href=\"{shop_url}\" target=\"_blank\" style=\"color: #25B9D7; text-decoration: underline; font-weight: 600;\">{shop_url}</a>
</div>
                                      </td>
                                    </tr>
                                    <tr>
...
";
    ...
    {
        return "@Modules/ps_reminder/mails/es/followup_4.html";
    }
    ...
    {
        return new Source("", "@Modules/ps_reminder/mails/es/followup_4.html", "/var/www/html/modules/ps_reminder/mails/es/followup_4.html");
    }
}
