...
class __TwigTemplate_e687cd974bba828d0ad0e359830c5e00 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/psgdpr/views/templates/admin/tabs/help.tpl", "/var/www/html/modules/psgdpr/views/templates/admin/tabs/help.tpl");
    }
}
