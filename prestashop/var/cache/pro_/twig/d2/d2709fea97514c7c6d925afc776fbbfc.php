...
class __TwigTemplate_3b3b0b839cecd19e062ee2686a4093ee extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_customeraccountlinks/config.xml", "/var/www/html/modules/ps_customeraccountlinks/config.xml");
    }
}
