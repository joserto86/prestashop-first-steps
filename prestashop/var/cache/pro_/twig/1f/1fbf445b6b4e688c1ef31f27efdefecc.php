...
class __TwigTemplate_16c11b9f1f39af1c58aa2af4a779fd9e extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        echo "            <span>
              ";
        // line 29
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Your order with the reference [1]{order_name}[/1] from [1]{shop_name}[/1] has been canceled.", ["[1]" => "<span><strong>", "[/1]" => "</strong></span>"], "Emails.Body", ($context["locale"] ?? null));
        echo "
            </span>
          </font>
        </td>
