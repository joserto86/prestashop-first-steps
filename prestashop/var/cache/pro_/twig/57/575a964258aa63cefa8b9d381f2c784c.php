...
class __TwigTemplate_bbf4a6f8317a6b891c3271e1c4cc9e2a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/psgdpr/upgrade/upgrade-1.4.2.php", "/var/www/html/modules/psgdpr/upgrade/upgrade-1.4.2.php");
    }
}
