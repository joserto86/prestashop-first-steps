...
class __TwigTemplate_ee4bd7b6e81a3c77c79504acd74bda31 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/psgdpr/views/templates/admin/tabs/getStarted.tpl", "/var/www/html/modules/psgdpr/views/templates/admin/tabs/getStarted.tpl");
    }
}
