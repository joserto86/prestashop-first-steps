...
class __TwigTemplate_6c1381fd582da373b2485260d10facef extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_linklist/src/Presenter/LinkBlockPresenter.php", "/var/www/html/modules/ps_linklist/src/Presenter/LinkBlockPresenter.php");
    }
}
