...
class __TwigTemplate_5a2b93f77e6a868cc524fac9f7061f3d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_shoppingcart/controllers/front/ajax.php", "/var/www/html/modules/ps_shoppingcart/controllers/front/ajax.php");
    }
}
