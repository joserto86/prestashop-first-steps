...
class __TwigTemplate_594b9e56832716ef1bd2537fa0056b26 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_searchbar/config.xml", "/var/www/html/modules/ps_searchbar/config.xml");
    }
}
