...
/* @Modules/referralprogram/mails/es/referralprogram-voucher.html */
class __TwigTemplate_6c9bbb12a5be514830e4125f81bad2be extends Template
{
    private $source;
    private $macros = [];
...
<head>
  <title> Cupón de descuento del programa de referidos </title>
  <!--[if !mso]><!-->
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; padding-top: 0px; padding-bottom: 0px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;font-weight:600;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Programa de Patrocinio</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Hemos creado un cupón de descuento a su nombre por referir a un amigo.<br>
                                            Aquí está el código de su cupón de descuento: {voucher_num}, por valor de <span class=\"label\" style=\"font-weight: 700;\">{voucher_num}</span>
                                          </div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align=\"left\" style=\"border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0px; padding: 10px 25px; word-break: break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:left;color:#363A41;\" align=\"left\">Copie y pegue este código durante el proceso de pago de su próximo pedido.</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
";
    ...
    {
        return "@Modules/referralprogram/mails/es/referralprogram-voucher.html";
    }
    ...
    {
        return new Source("", "@Modules/referralprogram/mails/es/referralprogram-voucher.html", "/var/www/html/modules/referralprogram/mails/es/referralprogram-voucher.html");
    }
}
