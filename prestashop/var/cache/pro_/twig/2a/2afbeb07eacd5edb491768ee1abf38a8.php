...
class __TwigTemplate_12e32a07907d1fbf9e936269a04cb3b1 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/ps_faviconnotificationbo/composer.lock", "/var/www/html/modules/ps_faviconnotificationbo/composer.lock");
    }
}
