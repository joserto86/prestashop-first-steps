...
class __TwigTemplate_0593939a0766b55dad4429d28a0d5205 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        echo "            <span>
              ";
        // line 29
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Your order with the reference [1]{order_name}[/1] from [1]{shop_name}[/1] has been changed by the merchant.", ["[1]" => "<span><strong>", "[/1]" => "</strong></span>"], "Emails.Body", ($context["locale"] ?? null));
        echo "
            </span>
          </font>
        </td>
