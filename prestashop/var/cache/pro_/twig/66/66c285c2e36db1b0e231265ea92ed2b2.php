...
/* @Modules/ps_reminder/mails/es/followup_2.txt */
class __TwigTemplate_1cecccbc7d59b5aa0c6539a374b966fa extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@Modules/ps_reminder/mails/es/followup_2.txt";
    }
    ...
    {
        return new Source("", "@Modules/ps_reminder/mails/es/followup_2.txt", "/var/www/html/modules/ps_reminder/mails/es/followup_2.txt");
    }
}
