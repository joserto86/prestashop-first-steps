...
class __TwigTemplate_1e3938ec6310688aa385979bcd4c7179 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Modules/blockwishlist/src/Search/WishListProductSearchProvider.php", "/var/www/html/modules/blockwishlist/src/Search/WishListProductSearchProvider.php");
    }
}
