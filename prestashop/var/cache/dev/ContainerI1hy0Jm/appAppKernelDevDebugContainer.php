...
class appAppKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'WebHelpers\\WHCallback\\Controller\\AdminWHCallbackRequestController' => 'getAdminWHCallbackRequestControllerService.php',
            'WebHelpers\\WHCategoryFields\\Controller\\AdminWHCategoryFieldsController' => 'getAdminWHCategoryFieldsControllerService.php',
            ...
            'webhelpers.whcallback.domain.setting.command_handler.edit_setting' => 'getWebhelpers_Whcallback_Domain_Setting_CommandHandler_EditSettingService.php',
            'webhelpers.whcallback.domain.setting.query_handler.get_setting_for_editing_handler' => 'getWebhelpers_Whcallback_Domain_Setting_QueryHandler_GetSettingForEditingHandlerService.php',
            'webhelpers.whcallback.domain.whcallbackrequest.command_handler.delete_request' => 'getWebhelpers_Whcallback_Domain_Whcallbackrequest_CommandHandler_DeleteRequestService.php',
            'webhelpers.whcallback.form.identifiable_object.builder.setting_form_builder' => 'getWebhelpers_Whcallback_Form_IdentifiableObject_Builder_SettingFormBuilderService.php',
            'webhelpers.whcallback.form.identifiable_object.data_handler.setting_form_data_handler' => 'getWebhelpers_Whcallback_Form_IdentifiableObject_DataHandler_SettingFormDataHandlerService.php',
            'webhelpers.whcallback.form.identifiable_object.data_provider.setting_form_data_provider' => 'getWebhelpers_Whcallback_Form_IdentifiableObject_DataProvider_SettingFormDataProviderService.php',
            'webhelpers.whcallback.form.identifiable_object.handler.setting_form_handler' => 'getWebhelpers_Whcallback_Form_IdentifiableObject_Handler_SettingFormHandlerService.php',
            'webhelpers.whcallback.grid.data.factory.whcallbackrequest_data_factory' => 'getWebhelpers_Whcallback_Grid_Data_Factory_WhcallbackrequestDataFactoryService.php',
            'webhelpers.whcallback.grid.definition.factory.whcallbackrequest_grid_definition_factory' => 'getWebhelpers_Whcallback_Grid_Definition_Factory_WhcallbackrequestGridDefinitionFactoryService.php',
            'webhelpers.whcallback.grid.query.whcallbackrequest_query_builder' => 'getWebhelpers_Whcallback_Grid_Query_WhcallbackrequestQueryBuilderService.php',
            'webhelpers.whcallback.grid.whcallbackrequest_grid_factory' => 'getWebhelpers_Whcallback_Grid_WhcallbackrequestGridFactoryService.php',
            'webhelpers.whcallback.repository.whcallbackrequest_repository' => 'getWebhelpers_Whcallback_Repository_WhcallbackrequestRepositoryService.php',
            'webhelpers.whcategoryfields.domain.hcategoryfieldsextension.command_handler.add_extension' => 'getWebhelpers_Whcategoryfields_Domain_Hcategoryfieldsextension_CommandHandler_AddExtensionService.php',
            'webhelpers.whcategoryfields.domain.hcategoryfieldsextension.command_handler.delete_extension' => 'getWebhelpers_Whcategoryfields_Domain_Hcategoryfieldsextension_CommandHandler_DeleteExtensionService.php',
            'webhelpers.whcategoryfields.domain.hcategoryfieldsextension.command_handler.delete_extension_file' => 'getWebhelpers_Whcategoryfields_Domain_Hcategoryfieldsextension_CommandHandler_DeleteExtensionFileService.php',
            'webhelpers.whcategoryfields.domain.hcategoryfieldsextension.command_handler.edit_extension' => 'getWebhelpers_Whcategoryfields_Domain_Hcategoryfieldsextension_CommandHandler_EditExtensionService.php',
            'webhelpers.whcategoryfields.repository.whcategoryfieldsextension_repository' => 'getWebhelpers_Whcategoryfields_Repository_WhcategoryfieldsextensionRepositoryService.php',
        ];
        $this->aliases = [
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'db', 'port' => '', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'farsa', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/modules/whcallback/src/Entity')]);
        $e->addExcludePaths([0 => (\dirname(__DIR__, 4).'/modules/whcallback/src/Entity/index.php')]);
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/modules/whcategoryfields/src/Entity')]), 'WebHelpers\\WHCategoryFields\\Entity');
        $b->addDriver($d, 'PrestaShop\\Module\\ProductComment\\Entity');
        $b->addDriver($e, 'WebHelpers\\WHCallback\\Entity');
        ...
        $a->addEntityNamespace('Modulewhcategoryfields', 'WebHelpers\\WHCategoryFields\\Entity');
        $a->addEntityNamespace('Moduleproductcomments', 'PrestaShop\\Module\\ProductComment\\Entity');
        $a->addEntityNamespace('Modulewhcallback', 'WebHelpers\\WHCallback\\Entity');
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2vrO5AHHqRMXPoPxdSARrksK50DmZdaAR0YCZBAGI8qRfkXnYWIEu26LLxXdVos5'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => '2vrO5AHHqRMXPoPxdSARrksK50DmZdaAR0YCZBAGI8qRfkXnYWIEu26LLxXdVos5',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-02-13',
            'locale' => 'es-ES',
            'use_debug_toolbar' => true,
            'cookie_key' => 'JDcQUpWf1cTggcQiYj9axI76FpvcBnUif2PSa2Oi0aQxetz0unn8c7wWiF3cWrr6',
            'cookie_iv' => 'bG9z8LY41DDFFLIjwMiE1HK5aeByqyOh',
            'new_cookie_key' => 'def00000c9aef85f18f5b7ff8e7900d2a5b62f13e94d8415f9b5056aaa339f7bcf99983f8aac9fef0bc027757c04e42cb23b53550e7ed73810e78a8b171b7f37621c7cde',
            ...
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQCzSXdFyObM0FnN'."\n".'TIlOpWL2GyhnkTYK1HgR/r9rKqfH2qUONDgMp1zw1paa0h1EBWge3haxNw9vZ1h/'."\n".'o/HnFoccqrNVGh2V/lRGLrNMmslyGItH2Cd5O3748kXCv2/7FxSAwpvCjVZQeMo8'."\n".'sX1gotEVDvt9EUV4hfIS/4qT1U2w78hywMOD+4boGj796Z1El5hoP6dBVX/ZfQKe'."\n".'Val9MHQ+ioX2qljXh+VDLJIFiKhBuymMwRZ+nhFeVGYSmltV9aplu5Lf2ZdNxUdF'."\n".'E/PicLnfu8DTtFlKlwAQLVdy49fmzUuyxfFp1CQyl/xBMmiTuLUrHw58/q4C19Gr'."\n".'4foKcgTjAgMBAAECggEAR7LsqRLUAjqcfzbJfpMzhVqNCQYQh7o6nm+zW4c+e/Vb'."\n".'pteJRr4zs/kNV7MJkydaYWXNy2dKm/HHeZw15IWk2PkHKNR92ntQdpS8jbklMKTS'."\n".'JpQyDRCXEbXJ4j0u6kprn6a0JdTiHOKBdk5A5sGWPga02mpqzu06RxC8+awHGufO'."\n".'NtgivWmsKSlL+ntS3PpoUZouBXRUazFwtW0yZxY8znwZVAlbRxmNxOxaWuSRz0RD'."\n".'lwNdScAFEtAp3wjoCXEJr7e8egjvcjSMynl+PCU3aOBB/zWjklt4ijHX4QhoUo9c'."\n".'pqdrETWNKvrZ/pZd4NScTfH2o0GeMLKuZbiuc1QpyQKBgQDiEBimNq4bfJZm4D/j'."\n".'m7xMQq9BKzg4qLlgMllTcJAzQEuD4KGsCuNJRI78BVxv+n+fKcWTRCgjPBae4j8u'."\n".'22n4Nt2Y16ZK1Xj9l9KfwLyUk2iO6SIcCM0PgPiVyw3V5sVrl6zrRGbwt2TpNIKL'."\n".'jF/vyB2QmhKso/Qz8Z+CLOH6fwKBgQDLB5bv74nxrYKuNIGsr2r3exMpbFRyaryL'."\n".'SxlWgXDQQf7RKx2THaXNYocMndA4q6mnDU0bxzgVUDmcQhiqSs998Dkd2ilXPgO5'."\n".'XBVWibwA0yujJd/G5I5qrXtlMkUXeD6A9Ype0gjBvd+KtWZbfQXBK+TqbBiZmyCd'."\n".'NLm6uZAbnQKBgGE96Ux+UvCR7CR+rBzdXecz/C09SSbeNTeTEOeakPzq2FD3LLRT'."\n".'zqcyrYrtR3EHwSQXFN0fQWC+tUBNND6UtYXHHBVmFis0nqH/T+PWRYhnzF9FG54R'."\n".'jxvvL39H5ECxzxRUH1boiptbWDYUl18t2ArN+yG7lPLcZ+x8MFAPvHlDAoGBALyL'."\n".'LsthGyx54prenfH88YwkGnZkaMPchX2h30TrbhWow/gBXzSo2rmyHxJDWAPYvvMo'."\n".'sgvy5Q099FI9O2ShlrEwrgof+DZRm+m+Lv6vaA0oDiUzXe35gJxmwOoIVgtmmjzu'."\n".'SXKnAITTTE4nCYg6wWZT2gEtI2c6nX4AYd6axs4tAoGBAKcAORiGYliyz6WcjSSV'."\n".'pz39gmljdfXJi+OHD6hhlxLQrSt3pH5o3YqxEst1K6hgtD0JaZxYSxd1L/Yml1at'."\n".'VpCYvt/OERqkGQpd81JSi4SAzfdzmHhxyOIfYdF4TLLclaVXWwBbDevRq4p4J7Vr'."\n".'QAKXjAoqCn6Qk3Kh1/kJrIKb'."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                49 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
            ...
            'kernel.secret' => '2vrO5AHHqRMXPoPxdSARrksK50DmZdaAR0YCZBAGI8qRfkXnYWIEu26LLxXdVos5',
            ...
            'prestashop.commands_and_queries' => [
                ...
                388 => 'WebHelpers\\WHCategoryFields\\Domain\\WHCategoryFieldsExtension\\Command\\DeleteExtensionFileCommand',
                389 => 'WebHelpers\\WHCategoryFields\\Domain\\WHCategoryFieldsExtension\\Command\\AddExtensionCommand',
                390 => 'WebHelpers\\WHCategoryFields\\Domain\\WHCategoryFieldsExtension\\Command\\EditExtensionCommand',
                391 => 'WebHelpers\\WHCategoryFields\\Domain\\WHCategoryFieldsExtension\\Command\\DeleteExtensionCommand',
                392 => 'WebHelpers\\WHCallback\\Domain\\Setting\\Query\\GetSettingForEditing',
                393 => 'WebHelpers\\WHCallback\\Domain\\Setting\\Command\\EditSettingCommand',
                394 => 'WebHelpers\\WHCallback\\Domain\\WHCallbackRequest\\Command\\DeleteWHCallbackRequestCommand',
            ],
