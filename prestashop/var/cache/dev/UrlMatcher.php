...
return [
    ...
    [ // $staticRoutes
        ...
        '/modules/whcallback/list' => [
            [['_route' => 'admin_whcallbackrequest_list', '_controller' => 'WebHelpers\\WHCallback\\Controller\\AdminWHCallbackRequestController::listAction'], null, ['GET' => 0], null, false, false, null],
            [['_route' => 'admin_whcallbackrequest_search', '_controller' => 'WebHelpers\\WHCallback\\Controller\\AdminWHCallbackRequestController::searchAction'], null, ['POST' => 0], null, false, false, null],
        ],
        ...
        0 => '{^(?'
                ...
                .'|/modules/(?'
                    .'|link\\-widget/(?'
                        ...
                        .')'
                        .'|delete/(\\d+)(*:10492)'
                        .'|update\\-positions/(\\d+)(*:10525)'
                    .')'
                    .'|whca(?'
                        .'|tegoryfields/icon/delete/([^/]++)(*:10576)'
                        .'|llback/delete/([^/]++)(*:10608)'
                    .')'
                .')'
            .')/?$}sD',
    ...
    [ // $dynamicRoutes
        ...
        10576 => [[['_route' => 'admin_whcategoryfields_file_delete', '_controller' => 'WebHelpers\\WHCategoryFields\\Controller\\AdminWHCategoryFieldsController::deleteFileAction'], ['idCategory'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        10608 => [
            [['_route' => 'admin_whcallbackrequest_delete', '_controller' => 'WebHelpers\\WHCallback\\Controller\\AdminWHCallbackRequestController::deleteAction'], ['idRequest'], ['GET' => 0, 'POST' => 1], null, false, true, null],
