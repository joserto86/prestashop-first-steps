...
(isset($context["categoriesKpi"]) || array_key_exists("categoriesKpi", $context) ? $context["categoriesKpi"] : (function () { throw new RuntimeError('Variable "categoriesKpi" does not exist.', 40, $this->source); })())]));
  ...
  ";
    ...
    public function block_categories_listing($context, array $blocks = [])
    {
        ...
        // line 49
        echo "    ";
        $this->loadTemplate("@PrestaShop/Admin/Sell/Catalog/Categories/index.html.twig", "@PrestaShop/Admin/Sell/Catalog/Categories/index.html.twig", 49, "487552967")->display(twig_array_merge($context, ["grid" => (isset($context["categoriesGrid"]) || array_key_exists("categoriesGrid", $context) ? $context["categoriesGrid"] : (function () { throw new RuntimeError('Variable "categoriesGrid" does not exist.', 49, $this->source); })())]));
        // line 58
        echo "  ";
...
/* @PrestaShop/Admin/Sell/Catalog/Categories/index.html.twig */
class __TwigTemplate_c609d0ecca1b19dd111fdc0eb11bb110___487552967 extends Template
{
    private $source;
    private $macros = [];
